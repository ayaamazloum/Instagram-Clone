...
const UserPost = ({ post, userId }) => {
    ...
    return (
        <div className="post flex column gap-10">
            ...
            <p className="semi-bold xsm-text">{likes} likes</p>
            <div className="flex gap-20">
                <p className="semi-bold">{post.user.username}</p>
                <p>{post.caption}</p>
            </div>
            <div className="flex space-between">
                <input className="light-text xsm-text" type="text" placeholder="Add a comment..." />
                <p className="secondary-text xsm-text pointer">Post</p>
            </div>
        </div>
    )
}
